    ...
    <div className='w-screen flex flex-col justify-center items-center'>
      ...
      <div className='w-full sm:hidden h-auto px-[24px] py-[12px] bg-primary2 flex justify-end items-center'>
        ...
        </button>
        {
          ...
          <div className='animate-slideIn w-full sm:hidden top-0 right-0 left-0 z-[100] h-auto px-[32px] py-[16px] pb-[40px] bg-[#000] flex flex-col justify-center items-start gap-[32px] absolute'>
            <button className='w-fit self-end cursor-pointer' onClick={handleClick}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-x text-[#fff]"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
            </button>
            <NavLink to={"/"} className={({isActive})=>isActive?"text-primary2 font-medium":"text-[#a6a6a6] font-normal hover:text-primary"} onClick={handleClick}>Home</NavLink>
            <NavLink to={"/service"} className={({isActive})=>isActive?"text-primary2 font-medium":"text-[#a6a6a6] font-normal hover:text-primary"} onClick={handleClick}>Service</NavLink>
            <NavLink to={"/contactus"} className={({isActive})=>isActive?"text-primary2 font-medium":"text-[#a6a6a6] font-normal hover:text-primary"} onClick={handleClick}>Contact Us</NavLink>
          </div>
        }
      </div>
      ...
      <div className='w-full h-auto px-[24px] sm:px-[64px] py-[12px] bg-[#fff] flex flex-col md:flex-row justify-between items-center drop-shadow-md gap-[16px] md:gap-[30px] lg:gap-[50px]'>
        ...
        <div className='flex flex-col sm:flex-row justify-center items-center w-fit h-auto gap-[16px] sm:gap-[30px] md:gap-[50px] lg:gap-[80px]'>
          ...
          <div className='flex justify-center items-center gap-[10px]'>
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-mail-open"><path d="M21.2 8.4c.5.38.8.97.8 1.6v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V10a2 2 0 0 1 .8-1.6l8-6a2 2 0 0 1 2.4 0l8 6Z"/><path d="m22 10-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 10"/></svg>
            <span className='flex flex-col justify-center items-start gap-[2px]'>
